...
export default function ReviewSection() {
  return <>
    ...
    <h1 className='text-center text-4xl text-bold my-7 text-black'>Review Section</h1>
    <ul className="flex">
      <li className="py-8 text-left border px-4 m-2">
        <div className="flex items-start  ">
          <img className="block h-10 w-10 max-w-full flex-shrink-0 rounded-full align-middle" src={user} alt />
          <div className="ml-6">
